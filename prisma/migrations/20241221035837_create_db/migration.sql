...
-- CreateTable
CREATE TABLE "DirectMessageFriend" (
    "id" TEXT NOT NULL,
    "content" TEXT NOT NULL,
    "fileUrl" TEXT,
    "profileId" TEXT NOT NULL,
    ...
    CONSTRAINT "DirectMessageFriend_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "Profile_addCode_key" ON "Profile"("addCode");
...
-- CreateIndex
CREATE INDEX "DirectMessageFriend_profileId_idx" ON "DirectMessageFriend"("profileId");

-- CreateIndex
CREATE INDEX "DirectMessageFriend_friendId_idx" ON "DirectMessageFriend"("friendId");
...
-- AddForeignKey
ALTER TABLE "DirectMessageFriend" ADD CONSTRAINT "DirectMessageFriend_profileId_fkey" FOREIGN KEY ("profileId") REFERENCES "Profile"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "DirectMessageFriend" ADD CONSTRAINT "DirectMessageFriend_friendId_fkey" FOREIGN KEY ("friendId") REFERENCES "Friend"("id") ON DELETE CASCADE ON UPDATE CASCADE;
